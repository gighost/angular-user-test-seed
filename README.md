...
There are two kinds of tests in the `angular-user-test-seed` application: Unit tests and end-to-end tests.

### Running Unit Tests

The `angular-user-test-seed` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
